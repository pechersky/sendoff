...
@pytest.fixture
def single_titled_mol_sdf(tmp_path):
...
@pytest.fixture
def single_delimiter_titled_mol_sdf(tmp_path):
...
@pytest.fixture
def single_record_mol_sdf(tmp_path):
...
@pytest.fixture
def single_delimiter_record_mol_sdf(tmp_path):
...
@pytest.fixture
def single_multiline_record_mol_sdf(tmp_path):
...
@pytest.fixture
def single_empty_string_record_mol_sdf(tmp_path):
